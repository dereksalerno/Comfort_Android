...
public class OtherAmericanWhiskeyActivity extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		//requestWindowFeature(Window.FEATURE_NO_TITLE);
		final String WINDOW_TITLE = ("Other American Whiskey");
		setTitle(WINDOW_TITLE);
		setContentView(R.layout.activity_other_american_whiskey_linear);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_other_whiskey, menu);
		return true;
	}
